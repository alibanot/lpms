...
<div class="row g-3">
    <div class="col-12 col-xl-4">
        <div class="form-card">
            <h1 class="h5 mb-3"><?= $editRow ? 'Edit Event' : 'Add Event' ?></h1>
            <form method="post" data-event-balance>
                ...
                <button class="btn btn-primary w-100" type="submit"><?= $editRow ? 'Update Event' : 'Save Event' ?></button>
    ...
    <div class="col-12 col-xl-8">
        <div class="table-card">
            <h2 class="h5 mb-3">Event Records</h2>
            <div class="table-responsive">
                <table class="table table-striped align-middle datatable">
                    <thead><tr><th>Event Date</th><th>Place</th><th>Package</th><th>Price</th><th>Deposit</th><th>Balance Paid</th><th>Balance Remaining</th><th>Actions</th></tr></thead>
                    <tbody>
