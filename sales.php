...
<div class="row g-3">
    <div class="col-12 col-xl-4">
        <div class="form-card">
            <h1 class="h5 mb-3"><?= $editRow ? 'Edit Sale' : 'Add Sale' ?></h1>
            <form method="post" data-calc-total>
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" name="sale_type" required>
                        <?php foreach ($saleTypes as $type): ?>
                            <option value="<?= h($type) ?>" <?= (($editRow['sale_type'] ?? '') === $type) ? 'selected' : '' ?>><?= h($type) ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
                <div class="row g-2">
                ...
                <button class="btn btn-primary w-100" type="submit"><?= $editRow ? 'Update Sale' : 'Save Sale' ?></button>
        ...
        <div class="table-card">
            ...
            <div class="table-responsive">
                <table class="table table-striped align-middle datatable">
                    <thead><tr><th>Date</th><th>Type</th><th>Qty</th><th>Unit Price</th><th>Total</th><th>Remarks</th><th>Actions</th></tr></thead>
                    <tbody>
